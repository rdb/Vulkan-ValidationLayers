...
static uint32_t type_to_descriptor_type_bits(shader_module const *module, uint32_t type_id, unsigned &descriptor_count) {
    auto type = module->get_def(type_id);
...
static bool validate_pipeline_shader_stage(layer_data *dev_data, VkPipelineShaderStageCreateInfo const *pStage,
    ...
    for (auto use : descriptor_uses) {
        ...
        uint32_t descriptor_type_bits = type_to_descriptor_type_bits(module, use.second.type_id, required_descriptor_count);
